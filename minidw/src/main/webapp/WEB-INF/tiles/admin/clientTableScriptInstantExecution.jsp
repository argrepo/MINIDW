...
<input type="hidden" id="userID" value="${principal.userId}">
<c:url value="/admin/clientTableScripts/instantExecution" var="url"/>

<c:url value="/admin/clientTableScripts/instantExecution" var="executeScripts"/>
<input type="hidden" value="${executeScripts}" id="executeScriptsUrl">

<c:url value="/admin/clientTableScripts/instantExecution/previous" var="previousExecuteScripts"/>
