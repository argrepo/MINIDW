	...
	<form:form modelAttribute="webServiceTemplateMaster" action="${editUrl}">
		...
		<c:choose>
		 ...
		 <div class='row form-group'>
								...
								<div class='row form-group'>
									...
									<div class="col-sm-6">
										<form:select path="dateFormat" cssClass="form-control dateFormat" >
											...
											<form:option value="yyyy-MM-dd'T'HH:mm:ss'Z'"><c:out value="yyyy-MM-dd'T'HH:mm:ss'Z'" /></form:option>
											<form:option value="yyyy-MM-dd"><c:out value="yyyy-MM-dd" /></form:option>  
											<form:option value="MM-dd-yyyy"><c:out value="MM-dd-yyyy" /></form:option> 
											<form:option value="yyyy/MM/dd"><c:out value="yyyy/MM/dd" /></form:option>  
											<form:option value="yyyy-dd-MM"><c:out value="yyyy-dd-MM" /></form:option>  
											<form:option value="MM/dd/yyyy"><c:out value="MM/dd/yyyy" /></form:option>  
											<form:option value="yyyy-MM-dd'T'HH:mm:ss.SSSXXX"><c:out value="yyyy-MM-dd'T'HH:mm:ss.SSSXXX" /></form:option>  
											<form:option value="MMM dd yyyy HH:mm:ss.SSS zzz"><c:out value="MMM dd yyyy HH:mm:ss.SSS zzz" /></form:option>
										</form:select>
								 	</div>
							 	 </div>
	           	</div>
				...
				<div class='row form-group'>
		 			<label class="control-label col-sm-2"><spring:message code="anvizent.package.label.retrylimit" /> :</label>
					<div class="col-sm-6">
						<form:select path="retryLimit" cssClass="form-control retryLimit">
			 	 ...
			 	 <div class='row form-group'>
		 			<label class="control-label col-sm-2"><spring:message code="anvizent.package.label.sleeptime" /> :</label>
					<div class="col-sm-6">
						<form:select path="sleepTime" cssClass="form-control sleepTime">
							 <c:forEach var = "i" begin = "1" end = "10">
								 <form:option value="${i*1000}"><c:out value="${i*1000}"/></form:option>
							 </c:forEach>
						</form:select>
				 	</div>
			 	 </div>
					...
					<div class="panel panel-info authView" style='display:none;'>
						...
						<div class="panel-body">
							...
							<div class="row form-group loginurl">
								<label class="control-label col-sm-2"> Login URL :</label>
								<div class="col-sm-10">
								    <spring:message code="anvizent.package.label.enterUrl" var="enterUrl" />
									<form:input path="loginUrl" placeholder="${enterUrl}"  data-minlength="1" data-maxlength="255" cssClass="form-control"/>
								</div>
							</div>
							<div class="row form-group logouturl">
								...
								<div class="col-sm-10">
								    <spring:message code="anvizent.package.label.enterUrl" var="enterUrl" />
									<form:input path="logoutUrl" placeholder="${enterUrl}"  data-minlength="1" data-maxlength="255" cssClass="form-control"/>
								</div>
							</div>
							...
							<form:hidden path="apiSessionAuthURL" class="apiSessionAuthURL"/>
							...
							<div class="row form-group webServicesCoveringDiv" style='display:none;'>
								<div class='row form-group'>
				           	     ...
				           	     <div class='row form-group clientIdentifier' style='display:none;'>
											  <label class='col-sm-2 control-label'><spring:message code="anvizent.package.label.clientIdentifier" /> :</label>
											    <spring:message code="anvizent.package.label.clientIdentifier" var="clientIdentifier" /> 
											   <div class='col-sm-10' >
													<form:input path="oAuth2.clientIdentifier"  placeholder="${clientIdentifier}" cssClass="form-control"/>
											   </div>
								 </div>
								 <div class='row form-group clientSecret' style='display:none;'>
											  <label class='col-sm-2 control-label'><spring:message code="anvizent.package.label.clientSecret" /> :</label>
											     <spring:message code="anvizent.package.label.clientSecret" var="clientSecret" />  
											   <div class='col-sm-10' >
													<form:input type="password" placeholder="${clientSecret}" cssClass="form-control" path="oAuth2.clientSecret" />
											   </div>
								 </div>
                                  <div class='row form-group scope' style='display:none;'>
											  ...
											  <spring:message code="anvizent.package.label.scope" var="scope" />  
											   <div class='col-sm-10' >
													<form:input cssClass="form-control" placeholder="${scope}(Optional)" path="oAuth2.scope" />
											   </div>
								  </div>	
								 <div class='row form-group scope' style='display:none;'>
											  <label class='col-sm-2 control-label'><spring:message code="anvizent.package.label.state" /> :</label>
											  <spring:message code="anvizent.package.label.state" var="state" />  
											   <div class='col-sm-10' >
													<form:input cssClass="form-control"  placeholder="${state}(Optional)" path="oAuth2.state" />
											   </div>
								 </div>		
								...
								<!--  oAuth1 Started -->
								  <div class='row form-group oAuth1RequestURL' style='display:none;'>
											  <label class='col-sm-2 control-label'><spring:message code="anvizent.package.label.requestURL" /> :</label>
											   ...
											   <div class='col-sm-10' >
													<form:input path="oAuth1.requestURL"  placeholder="${requestURL}" cssClass="form-control"/>
											   </div>
								 </div>
								 <div class='row form-group oAuth1TokenURL' style='display:none;'>
											  <label class='col-sm-2 control-label'><spring:message code="anvizent.package.label.tokenURL" /> :</label>
											   ...
											   <div class='col-sm-10' >
													<form:input cssClass="form-control"  placeholder="${tokenURL}" path="oAuth1.tokenURL" />
											   </div>
								 </div>
                                  <div class='row form-group oAuth1AuthURL' style='display:none;'>
											  <label class='col-sm-2 control-label'><spring:message code="anvizent.package.label.authenticationUrl" /> :</label>
											   ...
											   <div class='col-sm-10' >
													<form:input cssClass="form-control" placeholder="${authenticationUrl}" path="oAuth1.authURL" />
											   </div>
								  </div>	
								   <div class='row form-group oAuth1CallbackURL' style='display:none;'>
											  <label class='col-sm-2 control-label'><spring:message code="anvizent.package.label.callbackUrl" /> :</label>
											   ...
											   <div class='col-sm-10' >
													<form:input cssClass="form-control" placeholder="${callbackUrl}" path="oAuth1.callbackURL" />
											   </div>
								  </div>
								   <div class='row form-group oAuth1ConsumerKey' style='display:none;'>
											  ...
											  <spring:message code="anvizent.package.label.consumerKey" var="consumerKey" />  
											   <div class='col-sm-10' >
													<form:input cssClass="form-control" placeholder="${consumerKey}" path="oAuth1.consumerKey" />
											   </div>
								  </div>
								   <div class='row form-group oAuth1ConsumerSecret' style='display:none;'>
											  ...
											  <spring:message code="anvizent.package.label.consumerSecret" var="consumerSecret" /> 
											   <div class='col-sm-10' >
													<form:input cssClass="form-control" placeholder="${consumerSecret}" path="oAuth1.consumerSecret" />
											   </div>
								  </div>
								   <div class='row form-group oAuth1SignatureMethod' style='display:none;'>
											  <label class='col-sm-2 control-label'><spring:message code="anvizent.package.label.signatureMethod" /> :</label>
											   <div class='col-sm-10' >
													<form:select path="oAuth1.signatureMethod" cssClass="form-control signatureMethod" >
														<form:option value="0">Select Signature Method</form:option>
														<form:option value="HMAC-SHA1">HMAC-SHA1</form:option>
													</form:select>
											   </div>
								   </div>
								    <div class='row form-group oAuth1Version' style='display:none;'>
											 ...
											 <spring:message code="anvizent.package.label.version" var="oatuh1version" />  
											   <div class='col-sm-10' >
													<form:input cssClass="form-control" placeholder="${oatuh1version}" path="oAuth1.version" />
											   </div>
							   	 </div>
								    <div class='row form-group oAuth1Scope' style='display:none;'>
											  <label class='col-sm-2 control-label'><spring:message code="anvizent.package.label.scope" /> :</label>
											 <spring:message code="anvizent.package.label.scope" var="oatuh1scope" />  
											   <div class='col-sm-10' >
													<form:input cssClass="form-control" placeholder="${oatuh1scope}(Optional)" path="oAuth1.scope" />
											   </div>
							   	 </div>
								    <div class='row form-group oAuth1Realm' style='display:none;'>
											  ...
											  <spring:message code="anvizent.package.label.realm" var="realm" /> 
											   <div class='col-sm-10' >
													<form:input cssClass="form-control"  placeholder="${realm}(Optional)"  path="oAuth1.realm" />
											   </div>
								    </div>
