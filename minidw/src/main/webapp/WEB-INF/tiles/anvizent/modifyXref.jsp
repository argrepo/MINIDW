...
<div class="col-md-12 rightdiv" >
  ...
  <div class="col-xs-12">
	...
	<form:form modelAttribute="standardPackageForm" method="POST" id="standardPackageForm">
		...
		<input type="hidden" id="industryId" value ="<c:out value="1"/>">
		<input type="hidden" id="packageId" value ="<c:out value="0"/>">
		<input type="hidden" id="dLId" value ="<c:out value="0"/>">
		<input type="hidden" id="iLId" value ="<c:out value=""/>">
		<jsp:include page="_error.jsp"></jsp:include>
		 ...
		 <tbody>
		  	<c:forEach items="${ilsList}" var="ilsList" varStatus="increment">
		  		<tr>
		  			...
		  			<td><c:out value="${ilsList.iL_name }"/></td>
		  			
		  			<td><button type="button" style="margin-top:-6px;" data-ilid="<c:out value="${ilsList.iL_id}"/>" data-iLName="<c:out value="${ilsList.iL_name }"/>" data-iLTableName="<c:out value="${ilsList.il_table_name }"/>" class="btn btn-primary btn-sm  ilMappingingButton"><spring:message code ="anvizent.package.label.sourceampMapping"/></button></td>
		  			<td><button type="button" style="margin-top:-6px;" data-ilid="<c:out value="${ilsList.iL_id}"/>" data-iLName="<c:out value="${ilsList.iL_name }"/>" data-iLTableName="<c:out value="${ilsList.il_table_name }"/>" class="btn btn-primary btn-sm  ilXRefgButton" ${ilsList.standard?"":"disabled" }><spring:message code ="anvizent.package.label.xReference"/></button></td>
			      	<td><button type="button" style="margin-top:-6px;" data-ilid="<c:out value="${ilsList.iL_id}"/>" data-iLName="<c:out value="${ilsList.iL_name }"/>" data-iLTableName="<c:out value="${ilsList.il_table_name }"/>" class="btn btn-primary btn-sm  ilSplittingButton" ${ilsList.standard?"":"disabled" }><spring:message code ="anvizent.package.label.splitting"/></button></td>			      
		  		</tr>	
		  	</c:forEach>
		  </tbody>
      				...
      				<div class="xReferenceSourceMappingDiv" id="accordion"  style="border: 1px solid #000;padding: 10px;">
						...
						<div class='row form-group'>
							<div class='col-sm-4 col-lg-3'>
								...
								<input type="text" id="iLName" class="form-control" disabled>
							</div>
							<div class='col-sm-4 col-lg-3'>
      ...
      <div class="clearfix" style="height:20px;"></div>
	     ...
	     <table class="table table-striped table-bordered tablebg" id="tblIlsXrefIds">
			 <tbody>
			  	<tr>
			  		<th class="pull-right">
			  			<spring:message code ="anvizent.package.label.xRefKey"/>
			  		</th>
			  		<td>
			  			<select class="form-control xrefIdColumn">
			  			</select>
			  		</td>
			  	</tr>
			  </tbody>
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content" style="width:700px">
					      <div class="modal-header">
					       ...
					       <!--  <h4 class="modal-title" id="targetTableDirectPopUpHeader"></h4> -->
												...
												<form:form method="POST"  id="fileUploadForm_direct" enctype="multipart/form-data">
													...
													<div class='row form-group '>
														...
														<div class='col-sm-8' >
													     ...
													     <p class="help-block"><em><spring:message code = "anvizent.package.label.noteDateTimeFormat"/> <c:out value="< yyyy-MM-dd HH:mm:ss >"/></em></p>
														</div>	
													</div>
													</form:form>
													<div class="row">
										...
										<div class="panel panel-info" id="databaseConnectionPanel" style="display:none;">
											...
											<div class="panel-body">
												...
												<div class='row form-group IL_queryCommand' style="margin-top: -15px">
													<div class='col-sm-12'>
														<input class="form-control" id="procedureName" style="display:none;" placeholder="<spring:message code="anvizent.package.label.storedProcedure"/>">
													</div>
												</div>
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="tablePreviewPopUp" data-backdrop="static" data-keyboard="false" aria-hidden='true'>
     ...
     <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <!-- <h4 class="modal-title" id="tablePreviewPopUpHeader"></h4> -->
        <img src="<c:url value="/resources/images/anvizent_icon.png" />" class="anvizentLogo"/> 
