...
public class ServerConfigurationsForm {
	private int id;
	...
	public String toString() {
		return "ServerConfigurationsForm [id=" + id + ", serverName=" + serverName + ", shortName=" + shortName + ", description=" + description
				+ ", ipAddress=" + ipAddress + ", portNumber=" + portNumber + ", minidwSchemaName=" + minidwSchemaName + ", anvizentSchemaName="
				+ anvizentSchemaName + ", userName=" + userName + ", serverPassword=" + serverPassword + ", pageMode=" + pageMode + ", activeStatus="
				+ activeStatus + ", clientDbDetailsEndPoint=" + clientDbDetailsEndPoint + "]";
	}
