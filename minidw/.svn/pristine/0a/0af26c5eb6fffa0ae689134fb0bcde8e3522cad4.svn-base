							...
							<table class="table table-striped table-bordered tablebg " id="databaseConnectorTable">
								<thead>
									<tr>
										...
										<th><spring:message code="anvizent.package.label.protocol"/></th>
							...
							<div class="panel-body">
								<div class="row form-group">
									...
									<div class='col-sm-6'>
										...
										<form:hidden path="connectionStringParams" class="form-control"/>
										<spring:message code="anvizent.package.label.database" var="database"/>
										<form:input path="databaseName" class="form-control" placeholder="Ex:- MySQL" data-maxlength="255"/>
									</div>
							 	</div>
							<div class="row form-group">
									...
									<div class='col-sm-6'>
										...
										<form:input path="driverName" class="form-control" placeholder="Ex:- com.mysql.jdbc.Driver" data-maxlength="255"/>
									</div>
								</div>
								<div class="row form-group">
									<label class="control-label col-sm-2"><spring:message code="anvizent.package.label.protocol"/> :</label>
									<div class='col-sm-6'>
										<spring:message code="anvizent.package.label.protocol" var="protocal"/>
										<form:input path="protocal" class="form-control" placeholder="Ex:- jdbc:mysql://{hostname}:{port}/{dbname}" data-maxlength="255"/>
									</div>
								</div>
								<div class="row form-group">
								<label class="control-label col-sm-2"> </label>
								<div class='col-sm-6'>
								<table class="table table-striped table-bordered tablebg " id="requestParamsTable" hidden="" style="width:50">
								<thead>
										<tr>
											<th class="col-xs-4"><spring:message code = "anvizent.package.label.name"/></th>
								...
								<tfoot class="hidden">
									<tr>
									     <td><input type="text" class="form-control placeHolderLableName"/></td>
									     <td><input type="hidden" class="form-control placeHolderValue"/><span class="placeHolderValueSpan"></span></td>
								...
								<div class="row form-group">
									...
									<div class='col-sm-6'>
										...
										<form:input path="urlFormat" class="form-control" placeholder="Ex:- < IP Address:#PORT/dbname > || Ex : 127.0.0.1:3306/dbname" data-maxlength="255"/>
									</div>
								</div>
