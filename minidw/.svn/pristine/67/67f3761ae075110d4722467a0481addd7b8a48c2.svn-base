...
<div class="col-md-12 rightdiv">
	<div class='row form-group'>
		<h4 class="alignText">
			<spring:message code="anvizent.admin.label.createDL" />
		</h4>
	</div>
	<div class="col-md-10">
	...
	<div class="col-md-10 dlCreationMsg"></div>
	<div class="col-md-6">
		<form:form method="POST" id="createDlForm"
			...
			<div class="form-group">
				<label class="control-label col-sm-3"><spring:message
						code="anvizent.package.label.dLNameDisplayName" /></label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="dlName"
						placeholder="<spring:message code = "anvizent.package.label.enterDLName"/>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-3"><spring:message
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<textarea rows="4" cols="50" class="form-control" id="description"
						placeholder="<spring:message code = "anvizent.package.label.enterDLDescription"/>"></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-3"><spring:message
			...
			<div class="form-group" id="fileContainer0">
				...
				<div class="col-sm-6 ">
					<input type="file" class="filePath0 fileName" id="inputFile"
						name="files" data-buttonText="Find file">
				</div>
	...
	<div class="col-md-10">
		<div class="form-group">
			<div class="col-sm-offset-5 col-sm-6">
				...
				<button id='dlCreation' type="button" class="btn btn-primary btn-sm">
