...
<div class="col-md-12 rightdiv" >
    <div class='row form-group'>
     <h4 class="alignText"><spring:message code="anvizent.package.label.ilxrefdetails"/></h4>
    </div>
    <div class="col-md-10">
  ...
  <div class="col-xs-12">
	...
	<form:form modelAttribute="standardPackageForm" method="POST" id="standardPackageForm">
		...
		<input type="hidden" id="industryId" value ="1">
		<input type="hidden" id="packageId" value ="0">
		<input type="hidden" id="dLId" value ="0">
		<input type="hidden" id="iLId" value ="">
		<input type="hidden" id="receivedIlId" value ="${receivedIlId}">
	...
	<div class="alert alert-success successIlMessage" style="display:none;">
	  ...
	  <c:choose>
	  <c:when test="${not empty ilsList}">
	   
	  <div class="panel-group" id="accordionMain" role="tablist" aria-multiselectable="true">
	  
	  	<table class="table table-striped table-bordered tablebg table-fixed" id="tblIlsList">
			<thead id="tbHeadlIlsList">
				<tr>
					<th class="xrefsno col-xs-1"  ><spring:message code="anvizent.package.label.sNo"/></th>
					<th class="xreftables col-xs-3"  > <spring:message code="anvizent.package.label.xref.xreftables"/></th>
					<th class="xrefsources col-xs-2"  ><spring:message code="anvizent.package.label.xref.xrefsources"/></th>
					<th class="xrefmerging col-xs-2" ><spring:message code="anvizent.package.label.xReference"/></th>
					<th class="viewtableStructure col-xs-2"  ><spring:message code="anvizent.package.label.xref.viewtablestructure"/></th> 
					<th class="xrefdownloadtemplate col-xs-2"  ><spring:message code="anvizent.package.label.xref.downloadtemplate"/></th>
				</tr>
				</thead>
		 <tbody id="tbodylIlsList">
		  	<c:forEach items="${ilsList}" var="ilsList" varStatus="increment">
		  	<c:if test="${ilsList.xref_il_table_name != null }">
		  		<tr>
		  			<td class="col-xs-1">${increment.index+1}</td>
		  			<td class="col-xs-3">${ilsList.xref_il_table_name }</td>
		  			<td class="col-xs-2"><button type="button" style="margin-top:-6px;" data-ilid="${ilsList.iL_id}" data-iLName="${ilsList.iL_name }" data-iLTableName="${ilsList.iL_table_name }" data-XrefILName="${ilsList.xref_il_table_name }" class="btn btn-primary btn-sm  ilMappingingButton ilBtn${ilsList.iL_id}"><spring:message code="anvizent.package.label.sourceampMapping"/></button></td>
		  		    <td class="col-xs-2"><button type="button" style="margin-top:-6px;" data-ilid="${ilsList.iL_id}" data-iLName="${ilsList.iL_name }" data-iLTableName="${ilsList.iL_table_name }" data-XrefILName="${ilsList.xref_il_table_name }" class="btn btn-primary btn-sm  ilXRefgButton" ${ilsList.standard?"":"" }><spring:message code="anvizent.package.label.xReference"/></button></td>
		  		    <td class="col-xs-2"><button type='button' class='viewILSchema btn btn-primary btn-sm' data-iLId="${ilsList.iL_id}" data-iLName="${ilsList.xref_il_table_name }"> <spring:message code="anvizent.package.button.viewTableStructure"/> </button></td>
		  		    <td class="col-xs-2"><button type="button" data-ilid="${ilsList.iL_id}" data-iLName="${ilsList.iL_name }" data-iLTableName="${ilsList.il_table_name }" class="btn btn-primary btn-sm  downloadSampleTemplate" id="downloadTemplate"><span title="Download Template" class="glyphicon glyphicon-download-alt" aria-hidden="true"></span></button></td>	
		  		</tr>	
		  		 </c:if>
		  	</c:forEach>
      				...
      				<div class="xReferenceSourceMappingDiv" id="accordion"  style="border: 1px solid #000;padding: 10px;">
						...
						<div class='row form-group'>
							<div class='col-sm-4 col-lg-3'>
								<label class="control-label "><spring:message code="anvizent.package.label.xrefilName"/></label>
								<input type="text" id="iLName" class="form-control" disabled="disabled">
							...
							<table class="table table-striped table-bordered tablebg " id="customPackageTable">
								<thead>
									<tr>
										...
										<th><spring:message code="anvizent.package.button.preview"/></th>										
										<th><spring:message code="anvizent.package.label.mapping"/></th>
										<th class="mappingInfo"><spring:message code="anvizent.package.label.mappingInfo"/></th>
										<th class="mappingColumn"><spring:message code="anvizent.package.label.merging"/></th>
										<th class="viewConditions"><spring:message code="anvizent.package.label.mergeCondition"/></th>
										<th class="splitColumn"><spring:message code="anvizent.package.label.splitting"/></th>
										<th class="deleteIlColumn"><spring:message code="anvizent.package.label.delete"/></th>
										<th class="splitColumnCondition" ><spring:message code="anvizent.package.label.viewsplitttingCondition"/></th>
						...
						<div style="padding-top: 10px;">
							<button type="button" class="btn btn-primary btn-sm" id="closexReferenceSourceMappingBackBtn"><spring:message code="anvizent.package.link.back"/></button>
						</div>
					</div>
      ...
      <div class="clearfix" style="height:40px;"></div>
	      ...
	      <div class="col-xs-12" >
	        <div class='row form-group'>
			<div class='col-sm-4 col-lg-3'>
			    <label class="control-label" id="xref_il_table_name"></label>
			    <select id="xRefILName" name="xRefILName" class="form-control">
			    <option value="SelectColumn">Select Column</option>
			    </select>
			</div>
			<div class='col-sm-4 col-lg-3' id="xRefILNameValueDiv">
				 
			</div>
			<div class='col-sm-2 col-lg-2'> </div>
			<div class='col-sm-1 col-lg-2'>
				<label class="control-label">&nbsp;</label>
			    <input type="button" class="btn btn-primary btn-sm form-control" title="GetIlMergeData" id="getIlData" value="GetIlMergeData"> 
			</div>
		 </div>
		  
		   <div class="col-xs-12">
		  <div class='row form-group' id="iltableName" style="display:none">
				    <h4 class="alignText" id="iltableNameVal"></h4>
		  </div>
		  
		  <div class="row form-group">
			<div class="table-responsive">
				 <div style="overflow:auto;max-height:50%">
					<table class="table table-striped table-bordered tablebg" id="iltableData">
					</table>
				</div>
			</div>
		  </div>
		  <div class="table-responsive">
		  <div style="overflow:auto;max-height:auto" class='proceedValidation'></div>
		  </div>
		  <div style="padding-top: 10px;">
		    <input type="button" class="btn btn-primary btn-sm" value="Proceed" id="proceedXrefSplitting" name="proceedXrefSplitting" style="display:none">
			<button type="button" class="btn btn-primary btn-sm" id="closexReferenceSplittingBackBtn"><spring:message code="anvizent.package.link.back"/></button>
		  </div>
		  </div>
      ...
      <div class="xReferenceDetailsDiv" style="border: 1px solid #000;padding: 10px;display:none;" >
      ...
      <div class="clearfix" style="height:20px;"></div>
									...
									<table class="table table-striped table-bordered tablebg" id="fileMappingWithILTable">
										<thead>
											<tr>
												...
												<th><spring:message code="anvizent.package.label.default"/></th>											</tr>
										</thead>
										 <tbody>
					      ...
					      <div id="mergingDiv-Xref">
					      	...
					      	<div>
						      	<button type="button" class="btn btn-primary xRefMergeButtons btn-sm" id="xrefByConditionId" data-divId="columnsDiv-Xref"><spring:message code="anvizent.package.label.xref.xrefbycondition"/></button>
						      	<button type="button" class="btn btn-primary xRefMergeButtons btn-sm" id="xrefByValuesId" data-divId="valuesDiv-Xref"><spring:message code="anvizent.package.label.xref.xrefbyvalues"/></button>
				      		</div>
					      ...
					      <div class="row groupBoxTemplate hidden">
							...
							<div class="pull-right addColumnBox">
								...
								<table class="table table-striped table-bordered tablebg tblForMergingConditions">
									<thead>
										<tr id="columnsRowForHrefValue">
											<th class="iLName col-xs-6"></th>
											<th class="originalFileName col-xs-6"></th>
											<th class="col-xs-2">
												<spring:message code="anvizent.package.label.delete"/>
											</th>
										</tr>
											<tr id="conditionNameForHrefValue">
											<td>
					      ...
					      <div class="row groupBoxTemplate hidden">
							...
							<div class="pull-right addColumnBox">
								...
								<table class="table table-striped table-bordered tablebg tblForMergingConditions">
									<thead>
										<tr id="columnsRowForHrefValue">
											<th class="iLName col-xs-3"></th>
											<th class="col-xs-3"><spring:message code="anvizent.package.label.columnValues"/></th>
											<th class="originalFileName col-xs-3"></th>
											<th class="col-xs-3"><spring:message code="anvizent.package.label.columnValues"/></th>
											<th class="col-xs-2">
												<spring:message code="anvizent.package.label.delete"/>
											</th>
									...
									<tbody>
										<tr class="hidden">
											<td>
												<select class="form-control selectIlColumnNameforMerging" data-colType="il" data-targetSelectBox="select.selectedIlColumnValue"></select>
											</td>
											<td>
												 <select class="form-control selectedIlColumnValue"> </select>  
											</td>
											<td>
												<select class="form-control selectSourceColumnNameforMerging" data-colType="xref"  data-targetSelectBox="select.selectedSourceColumnValue"></select>
											</td>
											<td>
												<select class="form-control selectedSourceColumnValue"></select>
											</td>
											<td>
												<button type="button" class="btn btn-sm btn-danger removeConditionBtn hidden">
												<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
					      ...
					      <div style="padding-top: 5px;">
							<button type="button" class="btn btn-primary btn-sm" id="closexReferenceDetailsBackBtn"><spring:message code="anvizent.package.link.back"/></button>
						</div>
      </div>
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content" style="width:700px">
					      <div class="modal-header">
					        <button type="button" class="close" data-dismiss="modal"  id='targetTablePopUpClose' ><span aria-hidden="true">&times;</span></button>
											...
											<div class="panel-heading"><spring:message code="anvizent.package.label.flatFileDetails"/></div>
												...
												<form:form method="POST"  id="fileUploadForm_direct" enctype="multipart/form-data">
													<div class='row form-group '>
														...
														<div class='col-sm-8'>
															<input type="text" class="form-control" id="flatFileSourceName" name="flatFileSourceName" value="" data-minlength="1" data-maxlength="200"> 
														</div>
													</div>
													<div class='row form-group '>
														<div class='col-sm-4'>
									...
									<div id='databaseConnectionDetails' style="display:none;">
										...
										<div class="panel panel-info" id="databaseConnectionPanel" style="display:none;">
											...
											<div class="panel-body">
													...
													<div class='col-sm-8'>
														<select  class="form-control" id="IL_database_databaseType">
															<c:forEach items="${databseList}" var="database">
																<option value="${database.id}" data-connectorId = "${database.connector_id}">${database.name}</option>
															</c:forEach>
														</select>
													</div>
												</div>
												...
												<div class='row form-group sourceName'>
														<div class='col-sm-4'>
															<spring:message code="anvizent.package.label.sourceName"/>
														</div>
														<div class='col-sm-8'>
															<input type="text" class="form-control" id="databaseSourceName" name="databaseSourceName" value=""  data-minlength="1" data-maxlength="200">
														</div>
													</div>
													...
													<div class='col-sm-6'>
													   ...
													   <c:if test="${principal.isTrailUser == false}">
													    ...
													    <c:if test="${principal.isTrailUser == true}">
													    	 <button type="button"  class="btn btn-primary btn-sm" id="" disabled="disabled"><spring:message code="anvizent.package.button.buildQuery"/> <img src="<c:url value="/resources/images/lock.png"/>" class="img-responsive lock-symbol" alt="Responsive image"></button>
													    </c:if>
													</div>
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="deleStandardSourceFileAlert" data-backdrop="static" data-keyboard="false">
		...
		<div class="modal fade" tabindex="-1" role="dialog" style='overflow-y:auto;max-height:90%; 'id="viewHeaderDeatilsPopUp" data-backdrop="static" data-keyboard="false" aria-hidden='true'>
			      <div class="modal-dialog" style="width: 45%;">
			     <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			        <img src="<c:url value="/resources/images/anvizent_icon.png" />" class="anvizentLogo"/> 
		        	<h4 class="modal-title custom-modal-title" id="viewHeaderDeatilsPopUpHeader"></h4>
			      </div>
			      <div class="modal-body table-responsive" style="max-height: 400px; overflow-y: auto;   overflow-x: auto;">
			      <table class='viewHeaderDeatils table table-striped table-bordered tablebg'></table>
			      </div>
			      <div class="modal-footer">
  ...
  <div class="modal-content">
   ...
   <div class="modal-footer">
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="downloadILTemplate" data-backdrop="static" data-keyboard="false">
		      ...
		      <div class="modal-body" >
		         <div class="container">
				    <label class="radio-inline">
				      <input type="radio" name="ilTemplate" id="ilCsv" checked>csv
				    </label>
					</div>
		      </div>
		      <div class="modal-footer">
		...
		<div class="modal fade" tabindex="-1" role="dialog" id="deleteXrefSourceAlert" data-backdrop="static" data-keyboard="false">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		      ...
		      <div class="modal-footer">
		      	<button type="button" class="btn btn-primary" id="confirmDeleteXrefSource"><spring:message code="anvizent.package.button.yes"/></button>
		        <button type="button" class="btn btn-default" data-dismiss="modal"><spring:message code="anvizent.package.button.no"/></button>
		      </div>
		    </div> 
		  </div> 
	...
	<!-- 	view merge conditions -->
		 <div class="modal fade" tabindex="-1" role="dialog" style='overflow-y:auto;max-height:90%; 'id="viewConditionsPopUp" data-backdrop="static" data-keyboard="false" aria-hidden='true'>
			      <div class="modal-dialog" style="width: 60%;">
			     <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			        <img src="<c:url value="/resources/images/anvizent_icon.png" />" class="anvizentLogo"/> 
		        	<h4 class="modal-title custom-modal-title" id="viewConditionsPopUpHeader"></h4>
			      </div>
			      <div class="modal-body table-responsive" style="max-height: 400px; overflow-y: auto;   overflow-x: auto;">
			      <table class='table table-striped table-bordered tablebg' id="viewConditions"> </table>
			      </div>
			      <div class="modal-footer">
			         <button type="button" class="btn btn-default viewDetailsclosePreview" data-dismiss="modal"><spring:message code="anvizent.package.button.close"/></button>
			      </div>
    ...
    <!-- 	view split conditions -->
     ...
     <div class="modal fade" tabindex="-1" role="dialog" style='overflow-y:auto;max-height:90%; 'id="viewSplittingConditionPopUp" data-backdrop="static" data-keyboard="false" aria-hidden='true'>
			      <div class="modal-dialog" style="width: 70%;">
			     <div class="modal-content">
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			        <img src="<c:url value="/resources/images/anvizent_icon.png" />" class="anvizentLogo"/> 
		        	<h4 class="modal-title custom-modal-title" id="viewSplittingConditionHeader"></h4>
			      </div>
			      <div class="modal-body table-responsive" style="max-height: 400px; overflow-y: auto;   overflow-x: auto;">
			      <table class='table table-striped table-bordered tablebg' id="viewSplittingCondition"> </table>
			      </div>
			      <div class="modal-footer">
			         <button type="button" class="btn btn-default viewDetailsclosePreview" data-dismiss="modal"><spring:message code="anvizent.package.button.close"/></button>
			      </div>
