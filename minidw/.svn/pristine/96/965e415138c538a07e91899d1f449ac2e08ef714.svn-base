...
<div class="col-md-12 rightdiv">
  	...
  	<div class='row form-group'>
		<h4 class="alignText"><spring:message code="anvizent.package.label.clientSpecificDL"/></h4>
 	</div>
	
	<jsp:include page="admin_error.jsp"></jsp:include>

 	<input type="hidden" id="userId" value="<c:out value="${principal.userId}"/>">
 	<c:url value="/admin/dashBoardLayoutMaster/clientMapping/specificDL" var="url"/>
 	...
 	<form:form modelAttribute="clientSpecificILDLForm" action="${url}" enctype="multipart/form-data">
			...
			<c:if test="${clientSpecificILDLForm.clientId != null && clientSpecificILDLForm.clientId != '0' }">
				<div class="row form-group">
			 		<label class="col-sm-3 labelsgroup control-label"><spring:message code="anvizent.package.label.dL"/> :</label>
					<div class="col-sm-8">
						<form:select path="dLId" cssClass="form-control">
							<spring:message code="anvizent.package.label.selectDL" var="selectDL" />
							<form:option value="0">${selectDL}</form:option>
							<form:options items="${dLsInfo}" />
						</form:select>
					</div>
			 	</div>
			 	
			 	<c:if test="${clientSpecificILDLForm.dLId != null && clientSpecificILDLForm.dLId != '0' }">
			 		<div class="col-sm-12">
				    	<div class="panel panel-default">
				    		<div class="panel-heading">Add / Update Client Specific DL Info</div>
				    		<div class="panel-body">
			    				...
			    				<div class="row form-group">
									...
									<div class="col-sm-8">
										...
										<span><c:out value="${not empty clientSpecificILDLForm.defaultJobName ? clientSpecificILDLForm.defaultJobName : '--'}"/></span>
									</div>
							 	</div>
							 	...
							 	<div class="row form-group">
									...
									<div class="col-sm-8">
										...
										<span><c:out value="${not empty clientSpecificILDLForm.defaultJobJarFileNames ? clientSpecificILDLForm.defaultJobJarFileNames : '--'}"/></span>
									</div>
							 	</div>
								 		...
								 		<div class="col-sm-8">
								 			<c:forEach items="${clientSpecificILDLForm.currentClientJarFileNameList}" var="jobFiles">
									 			<div class="currentJobFilesDiv">
									 				...
									 				<span style="margin-left: 20px;">${jobFiles}</span>
							 	...
							 	<div class="row form-group">
							 		<spring:message code="anvizent.package.label.version" var="clientSpecificJobVersion"/>
				    				<label class="col-sm-3 labelsgroup control-label"><spring:message code="anvizent.package.label.ClientSpecificJob"/> <c:out value="${clientSpecificJobVersion}"/> :</label>
				    				<div class="col-sm-8">
				    					<form:input path="clientSpecificJobVersion" cssClass="form-control" placeHolder="Client Specific Job ${clientSpecificJobVersion}" data-minlength="1" data-maxlength="45"/>
				    				</div>
				    			</div>
							 	...
							 	<div class="row form-group">
									...
									<div class="col-sm-8">
										<form:input path="clientSpecificJobName" placeHolder="${clientSpecificJobName}" data-minlength="1" data-maxlength="500" cssClass="form-control"/>
									</div>
							 	</div>
