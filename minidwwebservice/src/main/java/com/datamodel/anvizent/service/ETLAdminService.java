...
public interface ETLAdminService {
	...
	List<String> getDDlTableCreateScripts(String query ,JdbcTemplate jdbcTemplate);
	
	void createDDlTables(String[] createQuerys ,JdbcTemplate clientAppDbJdbcTemplate);
	...
	int saveSchedularMastereMapping(int clientId, List<Integer> schedularMappingIds, Modification modification, JdbcTemplate clientAppDbJdbcTemplate);

	int updateFilesetting(Integer id, JdbcTemplate clientJdbcTemplate);
