...
public class ScriptRunner {
   ...
   private StringBuilder executionComments = new StringBuilder();
   ...
   public String runScript(Reader reader) throws IOException, SQLException {
       ...
       return executionComments.toString();
   }
           ...
           while ((line = lineReader.readLine()) != null) {
               ...
               if (trimmedLine.length() < 1
                ...
                try {
					...
					executionComments.append(MinidwServiceUtil.getErrorMessageString(e)).append("\n");
				}
                   command = null;
               } else {
                   command.append(line);
