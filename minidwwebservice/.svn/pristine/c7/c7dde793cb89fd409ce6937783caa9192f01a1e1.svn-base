...
public interface AIService {
	...
	void deleteAISourceDefinitionBYId(int tagId, JdbcTemplate clientAppDbJdbcTemplate);
	...
	int saveAIGenericContextParams(AIJobUploadInfo aiJobUploadInfo, JdbcTemplate clientAppDbJdbcTemplate);
	
    int saveAiModel(AIModel aiModel, JdbcTemplate clientAppDbJdbcTemplate);
	
	List<AIModel> getAiModelInfo( JdbcTemplate clientAppDbJdbcTemplate );
