...
public class Constants {
	...
	final public static class DataBaseDrivers { 
	...
	final public static class DataBaseDriverURL {
		private DataBaseDriverURL() {
		}

		public static final String MYSQL_DB_URL = "jdbc:mysql://";
		public static final String MYSQL_DB_URL_PARAMS = System.getProperty("anvizent.mysql.db.url.params").trim();
	}
	...
	final public class SSL {
		private SSL() {
		}

		public static final String PASSWORD = "123456";
		public static final String TRUST_STORE = "truststore";
		public static final String KEY_STORE = "client-keystore.p12";
	}
