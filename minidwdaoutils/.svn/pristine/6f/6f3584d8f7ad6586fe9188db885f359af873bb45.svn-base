...
public interface QuartzDao {
	...
	int updateScheduledInfo(QuartzSchedulerInfo quartzSchedulerInfo, JdbcTemplate clientAppDbJdbcTemplate);
	...
	List<PackageExecution> getStoredUploadQueueList(long masterId);
