...
public interface DataValidationDao {
	...
	List<DataValidation> getValidationScriptByScriptId(String scriptIds,Integer connectionId,JdbcTemplate clientAppDbJdbcTemplate);
	...
	List<String> getContextParamsByValidationId(int scriptId, JdbcTemplate clientAppDbJdbcTemplate);

	Map<String, String> getDataValidationContextParams(Integer scriptId, JdbcTemplate clientAppDbJdbcTemplate);

	DataValidationType getValidationTypeNameById(Integer validationTypeId, JdbcTemplate clientAppDbJdbcTemplate);
